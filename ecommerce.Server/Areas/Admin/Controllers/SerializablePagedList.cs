...
namespace ecommerce.Server.Areas.Admin.Controllers
{
    ...
    public class SerializablePagedList<T> //: IPagedList<T>
    {

        private SerializablePagedList()
        {
        }
        ...
        public static SerializablePagedList<T> Create(IQueryable<T> queryable, int pageNumber, int pageSize)
        {
            var pagedList = new SerializablePagedList<T>();
        ...
        /// <param name="pageNumber"></param>
        /// <param name="pageSize"></param>
        public static async Task<SerializablePagedList<T>> CreateAsync(IQueryable<T> queryable, int pageNumber, int pageSize,
